    ...
    return (
      <div className="setup">
        ...
        <ul className="setup__steps">
          ...
          <li>
            <p>Install the <a href="https://expo.io/">Expo app on your iOS or Android phone</a> (from app store), and use the QR code in the terminal to open your app. Find the QR scanner on the Projects tab of the app and scan the QR code.</p>
